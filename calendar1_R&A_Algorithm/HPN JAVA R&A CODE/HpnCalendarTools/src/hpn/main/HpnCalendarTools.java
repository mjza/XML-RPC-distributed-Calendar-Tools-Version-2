...
public class HpnCalendarTools 
{
	...
	public static void main(String[] args) 
	{
		...
		try 
		{
			...
			System.out.println("                 <<< R&A Version >>>                ");
		    ...
		    client = HpnXmlRpcClient.getHpnXmlRpcClient(MachinIdentification.getPort(), MachinIdentification.getIpAddress(), calendar); //The port of this machine must be send to register the local host as the first host in the host list
			while (true)
			{
				client.controlPanel();
			}
